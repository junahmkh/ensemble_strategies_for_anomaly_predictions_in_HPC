...
for rack in racks:
    for f_w in f_ws:
        ...
        for i in range(len(files)):
            ...
            y_pred = svm.predict_proba(test_feat)[:, 1]
            ...
            os.makedirs(f"ensemble_models/SVM/{f_w}", exist_ok=True)

            filename = 'ensemble_models/SVM/{}/{}_{}.pickle'.format(f_w,rack,get_nodename(files[i]))
